...
if ((isset($_GET['redordid'])) && ($_GET['redordid'] != "")) {
  $deleteSQL = sprintf("DELETE FROM tblproductos WHERE idProductos=%s",
                       GetSQLValueString($_GET['redordid'], "int"));

  mysql_select_db($database_TinedaBrujo, $TinedaBrujo);
  $Result1 = mysql_query($deleteSQL, $TinedaBrujo) or die(mysql_error());
